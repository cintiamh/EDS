...
(function() {
  var BLOCK_SIZE, REFRESH_RATE, bombs, bombsList, canvas, context, countBombs, discoverNeighbors, discoverTiles, drawCharacter, drawDownButton, drawLine, drawSquareBack, drawTable, drawUpButton, explodeBomb, exploded, findItemInList, flagsList, flipPiece, flippedList, generateBombs, getMousePos, height, level, levels, mousePos, numColors, prepareCanvas, putFlag, running, setNewLevel, start, tileNeighbors, time, width;
