...
(function() {
  var BLOCK_SIZE, REFRESH_RATE, bombs, bombsList, callTimer, canvas, checkEndOfGame, context, convertNumToTimestamp, countBombs, discoverNeighbors, discoverTiles, drawCharacter, drawDownButton, drawLine, drawSquareBack, drawTable, drawUpButton, explodeBomb, exploded, findItemInList, fixDecimal, flagsList, flipPiece, flippedList, generateBombs, getMousePos, height, level, levelForm, levels, mousePos, numColors, prepareCanvas, putFlag, running, setFormListeners, setNewLevel, setNewLevelValue, start, tileNeighbors, time, updateBombs, width, won;
