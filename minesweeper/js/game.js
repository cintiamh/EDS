...
(function() {
  var BLOCK_SIZE, REFRESH_RATE, bombs, bombsList, callTimer, canvas, checkEndOfGame, context, convertNumToTimestamp, countBombs, discoverNeighbors, discoverTiles, drawBomb, drawCharacter, drawDownButton, drawLine, drawSquareBack, drawTable, drawUpButton, explodeBomb, exploded, findItemInList, fixDecimal, flagsList, flipPiece, flippedList, generateBombs, getMousePos, height, level, levelForm, levels, mousePos, numColors, prepareCanvas, putFlag, running, setFormListeners, setNewLevel, setNewLevelValue, start, tileNeighbors, time, updateBombs, width, won;
  ...
  explodeBomb = function() {
    ...
    return flagsList.map(function(flag) {
      if (!findItemInList(bombsList, flag.x, flag.y)) {
        ...
        return drawCharacter(flag.x, flag.y, "W", "#0000FF");
      }
    });
  };
