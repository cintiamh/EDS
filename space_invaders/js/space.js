...
(function() {
  var Alien, AliensBlock, BLOCK_SIZE, Canon, HEIGHT, HEIGHT_BLOCKS, SpriteImage, WIDTH, WIDTH_BLOCKS, aliensArr, aliensGroup, animation, animations, background, canon, canonSpeed, imageObj, layer, movCount, movDirection, movDownDist, movSideDist, stage, startTime,
  ...
  AliensBlock = (function() {

    function AliensBlock() {
      this.aliensGroup = new Kinetic.Group();
      this.rows = 0;
      this.cols = 0;
    }

    AliensBlock.prototype.initialize = function() {
