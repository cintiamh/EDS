...
(function() {
  var BLOCK_SIZE, BORDER, HEIGHT, HEIGHT_NUM_BLOCKS, WIDTH, WIDTH_NUM_BLOCKS, alienDownMove, alienMovPause, alienMoveDirection, alienSideMove, alienStrArr, alienWidth, aliensAnimation, aliensCount, aliensGroup, aliensGroupEndPos, aliensGroupExt, aliensGroupStartPos, aliensLayer, aliensWidthArr, animations, background, backgroundLayer, bulletSpeed, bulletsArr, bulletsGroup, canon, canonAnimation, canonLayer, canonSpeed, changeAlienDirection, checkBulletCol, imageObj, moveAliensBlock, moveCanon, shootNewBullet, stage, startTime;
  ...
  checkBulletCol = function() {
    var bullet, index, _i, _len, _results;
    index = 0;
    _results = [];
    for (_i = 0, _len = bulletsArr.length; _i < _len; _i++) {
      bullet = bulletsArr[_i];
