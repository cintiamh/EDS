...
(function() {
  var BLOCK_SIZE, BORDER, HEIGHT, HEIGHT_NUM_BLOCKS, WIDTH, WIDTH_NUM_BLOCKS, alienDownMove, alienMovPause, alienMoveDirection, alienSideMove, alienStrArr, alienWidth, aliensAnimation, aliensArr, aliensCount, aliensGroup, aliensGroupEndPos, aliensGroupExt, aliensGroupStartPos, aliensLayer, aliensWidthArr, animations, background, backgroundLayer, bulletSpeed, bulletsArr, bulletsGroup, canon, canonAnimation, canonLayer, canonSpeed, changeAlienDirection, checkBulletCol, imageObj, moveAliensBlock, moveCanon, removeBulletFromArray, shootNewBullet, stage, startTime;
  ...
  checkBulletCol = function() {
    var aX, aY, alien, bX, bY, bullet, index, _i, _len, _results;
    index = 0;
    _results = [];
    for (_i = 0, _len = bulletsArr.length; _i < _len; _i++) {
      bullet = bulletsArr[_i];
      if (bullet && bullet.getPosition().y < -BORDER) {
        _results.push(removeBulletFromArray(index));
      } else if (bullet) {
  ...
  removeBulletFromArray = function(index) {
    var bullet;
