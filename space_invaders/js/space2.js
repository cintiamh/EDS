...
(function() {
  var BLOCK_SIZE, BORDER, HEIGHT, HEIGHT_NUM_BLOCKS, WIDTH, WIDTH_NUM_BLOCKS, alienDownMove, alienMovPause, alienMoveDirection, alienSideMove, alienStrArr, alienWidth, aliensAnimation, aliensArr, aliensCount, aliensGroup, aliensGroupExt, aliensGroupLimits, aliensLayer, aliensWidthArr, animations, background, backgroundLayer, bulletSpeed, bulletsArr, bulletsGroup, canon, canonAnimation, canonLayer, canonSpeed, changeAlienDirection, checkAliensMinMax, checkBulletCol, imageObj, moveAliens, moveAliensBlock, moveCanon, removeBulletFromArray, resetAliensGroupLimits, shootNewBullet, stage, startTime;
  ...
  checkAliensMinMax = function() {
    ...
    return console.log(aliensGroupLimits);
  };
