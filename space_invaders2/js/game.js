...
(function() {
  var BLOCK_SIZE, BORDER, HEIGHT, HEIGHT_BLOCKS, WIDTH, WIDTH_BLOCKS, addScore, alienMovPause, alienStrArr, aliensAnimation, aliensArr, aliensDirection, aliensDownMove, aliensLayer, aliensSideMove, aliensWidthArr, animateAliens, animations, background, backgroundLayer, bullet_vel, bulletsAnimation, bulletsArr, canon, canon_vel, checkAliensGoDown, checkBulletCol, checkBulletsOut, checkGameOver, clearGame, createAliens, explosion, explosionAnim, explosionImg, game_over, go_left, go_right, imageObj, moveAliens, moveCanon, points, removeAlien, removeBullet, restartBtn, scoreStr, shoot, shootBullet, stage, startGame, start_time;
  ...
  addScore = function() {
    points += 10;
    return scoreStr.innerText = points;
  };
