...
(function() {
  var BLOCK_SIZE, BORDER, HEIGHT, HEIGHT_BLOCKS, WIDTH, WIDTH_BLOCKS, addScore, alienMovPause, alienStrArr, aliensAnimation, aliensArr, aliensDirection, aliensDownMove, aliensLayer, aliensSideMove, aliensWidthArr, animateAliens, animations, background, backgroundLayer, bullet_interval, bullet_vel, bulletsAnimation, bulletsArr, can_shoot, canon, canon_vel, checkAliensGoDown, checkBulletCol, checkBulletsOut, checkGameOver, clearGame, createAliens, explosion, explosionAnim, explosionImg, gameOverStr, game_over, go_left, go_right, imageObj, moveAliens, moveCanon, points, removeAlien, removeBullet, restartBtn, scoreStr, shoot, shootBullet, shoot_time, stage, startGame, start_time;
  ...
  aliensAnimation = new Kinetic.Animation(function(frame) {
    ...
    if (game_over) {
      ...
      clearGame();
      return gameOverStr.innerText = "GAME OVER";
