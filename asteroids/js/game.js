...
(function() {
  var BULLET_SPEED, HEIGHT, NUM_STARS, ROCK_SPEED, SHIP_DRAG, SHIP_MAX_VEL, WIDTH, backgroundLayer, bullets_arr, check_bullets, createRock, createRocks, end_thrust, fix_position, game, gameLayer, get_hypotenuse, is_bullet_outside, move_bullets, move_ship, n, rockImageObj, rock_animations, rocks_arr, rotate_ship, set_acceleration, set_rotation, set_thrust, ship, shipImageObj, ship_acceleration, ship_animation, ship_animations, ship_rotation, ship_shoot, ship_velocity, stage, starsGroup, stars_arr, _i;
